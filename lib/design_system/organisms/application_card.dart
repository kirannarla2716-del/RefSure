...
class ApplicationCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) => SectionCard(
        onTap: job != null
            ? () => context.push(RouteNames.jobDetailPath(job!.id))
            : null,
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          if (app.matchReport != null) ...[
            ...
            MatchBandPill(
                band: app.matchReport!.band, label: app.matchReport!.bandLabel),
          ],
          ...
          if (app.responseDueAt != null &&
            ...
            const SizedBox(height: 8),
            Text(
              'Response due ${timeago.format(app.responseDueAt!, allowFromNow: true)}',
              style: GoogleFonts.inter(
                fontSize: 11,
          ...
          if (app.referralReceiptId != null) ...[
            const SizedBox(height: 8),
            Row(children: [
              const Icon(Icons.verified_outlined,
                  size: 15, color: AppColors.emerald),
              const SizedBox(width: 6),
              Text('Referral receipt verified',
                  style: GoogleFonts.inter(
                      fontSize: 11,
