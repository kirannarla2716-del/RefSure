...
class Application {
  ...
  String get statusLabel => switch (status) {
    ...
    AppStatus.strongMatch   => '\u{1F3AF} Strong Match',
    AppStatus.needsReview   => '\u{26A0}\u{FE0F} Needs Review',
    AppStatus.shortlisted   => 'Shortlisted',
    AppStatus.referred      => '\u{2705} Referred',
    AppStatus.interview     => '\u{1F4C5} Interview',
    AppStatus.hired         => '\u{1F389} Hired',
